    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-lg-10">
                ...
                <!-- Main Product Form -->
                <x-forms.form :action="route('vendor.products.store')" method="post" enctype="multipart/form-data" varient="reactive"
                    class="row">
                    <div class="col-lg-7 col-md-8">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <x-forms.hierarchical-select id="category_id" name="category_id"
                                                ...
                                                apiUrl="{{ route('vendor.categories.hierarchical_data') }}" :value="old('category_id')"
                                        ...
                                        <div class="col-12 mb-3">
                                            <x-forms.file name="images[]" label="Product Images"
                                                placeholder="Upload Product Images" :error="$errors->first('images')" :multiple="true"
                                                :useMediaLibrary="true" directory="products" accept="image/*" />
                        ...
                        <x-variant-select :initialOptions="$initialOptions" :initialVariants="$initialVariants" :attributesApiUrl="route('vendor.attributes.by-category')" />
