                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <x-forms.input name="last_name" label="Last name" placeholder="Enter Last Name"
                                                :value="old('last_name')" :error="$errors->first('last_name')" required />
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox"
                                                    ...
                                                    value="1" {{ old('email_marketing_consent') ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="sms_marketing_consent"
                                                    ...
                                                    {{ old('sms_marketing_consent') ? 'checked' : '' }}>
                                                <label class="form-check-label" for="sms_marketing_consent">
                                                    Customer agreed to receive SMS marketing text messages.
                                                </label>
                                            </div>
                                            <small class="text-muted mt-2 d-block">You should ask your customers for
                                                permission before you subscribe them to your marketing emails or
                                                SMS.</small>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card mt-3">
                            ...
                            <div class="card-body">
                                ...
                                <div id="add_address_placeholder"
                                    ...
                                    style="border-style: dashed !important;" data-bs-toggle="modal"
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetchZones(countryId, selectedProvince = null) {
                ...
                const telCode = selectedOption.data(
                'telcode'); // Ensure adding data-telcode to modal options first (wait, did I?)
