                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <div class="input-group">
                                                <div class="position-relative d-flex align-items-center" style="width: 80px;">
                                                    ...
                                                    <select class="form-select position-absolute top-0 start-0 w-100 h-100 opacity-0" name="phone_code" id="phone_code_select" style="cursor: pointer; z-index: 10;">
                                                        @foreach($countries as $country)
                                                            <option value="{{ $country->telcode }}" data-flag="{{ $country->flag_url }}" @selected($country->telcode == $customer->tel)>
                                                ...
                                                <input type="text" class="form-control" name="phone" id="phone_number_input" placeholder="+1 123 456 7890" value="{{ old('phone', $customer->phone) }}">
                                            </div>
                                            @if($errors->has('phone'))
