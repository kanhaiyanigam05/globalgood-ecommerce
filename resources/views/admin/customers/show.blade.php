    ...
    <div class="container-fluid">
        ...
        <div class="row m-1">
            <div class="col-12 d-flex justify-content-between align-items-center">
                <div>
                    <h4 class="main-title mb-0"><a href="{{ route('admin.customers.index') }}" class="text-muted"><i
                                class="ph ph-arrow-left"></i></a> {{ $customer->full_name }}</h4>
                </div>
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item"
                                    href="{{ route('admin.customers.edit', Crypt::encryptString($customer->id)) }}">Edit
                                    Customer</a></li>
                            <li>
                                <form action="{{ route('admin.customers.destroy', Crypt::encryptString($customer->id)) }}"
                                    method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="dropdown-item text-danger"
                                        onclick="return confirm('Are you sure?')">Delete Customer</button>
                                </form>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="col-lg-8">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body text-center p-5">
                        <div class="mb-3">
                            <img src="https://cdn-icons-png.flaticon.com/512/1170/1170576.png" width="80"
                                alt="No orders" class="opacity-50">
                        </div>
                    ...
                    <div class="card-body">
                        <div class="timeline-container">
                            <div class="d-flex gap-3 mb-4">
                                ...
                                <div class="flex-grow-1">
                                    <div class="border rounded p-2">
                                        ...
                                        <div
                                            class="d-flex justify-content-between align-items-center mt-2 p-1 border-top pt-2">
                            ...
                            <div class="timeline-item d-flex gap-3">
                                <div class="timeline-line bg-light mx-auto"
                                    style="width: 2px; height: 100%; position: absolute; left: 19px; z-index: -1;"></div>
                                <div class="timeline-dot bg-secondary rounded-circle"
                                    style="width: 10px; height: 10px; margin-left: 15px; margin-top: 5px;"></div>
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mb-4">
                            <li class="mb-1"><a href="mailto:{{ $customer->email }}">{{ $customer->email }}</a> <i
                                    class="ph ph-copy text-muted cursor-pointer"></i></li>
                            <li class="mb-1 text-muted">{{ $customer->phone ?: 'No phone number' }}</li>
                            <li class="text-muted">Will receive notifications in
                                {{ $customer->language === 'en' ? 'English' : $customer->language }}</li>
                        </ul>
                        ...
                        <ul class="list-unstyled mb-4">
                            <li class="text-muted"><i class="ph ph-circle f-s-10"></i>
                                {{ $customer->email_marketing_consent ? 'Email subscribed' : 'Email not subscribed' }}</li>
                            <li class="text-muted"><i class="ph ph-circle f-s-10"></i>
                                {{ $customer->sms_marketing_consent ? 'SMS subscribed' : 'SMS not subscribed' }}</li>
                        </ul>
