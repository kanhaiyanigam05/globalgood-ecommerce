    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-lg-10">
                ...
                <!-- Main Product Form -->
                <x-forms.form :action="route('admin.products.update', Crypt::encryptString($product->id))" method="put" enctype="multipart/form-data" varient="reactive"
                    class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <x-forms.hierarchical-select id="category_id" name="category_id"
                                                ...
                                                apiUrl="{{ route('admin.categories.hierarchical_data') }}" :value="old('category_id', $product->category_id)"
                                        ...
                                        <div class="col-12 mb-3">
                                            <x-forms.file name="images[]" label="Product Images" :multiple="true"
                                                :value="$product->images->map(fn($img) => $img->media ?: $img->file)"
                                                :useMediaLibrary="true"
                                                directory="products"
                                                accept="image/*" />
                                            <p class="small text-muted mt-2">The first image will be used as the feature image.</p>
