...
<div class="container-fluid py-4" style="max-width: 1100px;">
    <div class="d-flex align-items-center mb-4">
        ...
        <h4 class="mb-0 f-w-700">Create amount off products discount</h4>
    </div>

    <form action="{{ route('admin.discounts.store') }}" method="POST">
        @csrf
        <input type="hidden" name="type" value="amount_off_products">
            ...
            <div class="col-lg-8">
                <div class="discount-card">
                    ...
                    <div class="discount-card-body">
                        ...
                        <div id="codeSection">
                            ...
                            <input type="text" name="code" class="form-control discount-code-input" placeholder="e.g. SUMMER2024" required>
                        </div>
                ...
                <div class="discount-card">
                    ...
                    <div class="discount-card-body">
                        ...
                        <div class="form-check mb-3"><input class="form-check-input" type="radio" name="min_requirement_type" id="min_quantity" value="quantity"><label class="form-check-label" for="min_quantity">Minimum quantity of items</label></div>
                        <div id="minQuantityInput" class="ms-4 d-none"><input type="number" name="min_qty_value" class="form-control" style="width: 150px;" placeholder="0"></div>
                    </div>
                </div>
