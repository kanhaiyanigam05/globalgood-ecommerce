                ...
                <x-forms.form :action="route('admin.collections.update', Crypt::encryptString($collection->id))" method="put" enctype="multipart/form-data" varient="reactive"
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card shadow-sm mb-4">
                            ...
                            <div class="card-body">
                                <x-forms.file name="image" label="Collection Image" :value="$collection->image" :error="$errors->first('image')"
                                    accept="image/*" />
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.remove-product-btn', function() {
                ...
                if ($('#selected-products-table tbody tr').length === 0 || ($(
                        '#selected-products-table tbody tr').length === 1 && $(
                        '#no-products-placeholder').length)) {
