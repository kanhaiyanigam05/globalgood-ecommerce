...
@push('styles:before')
    ...
    <!-- glight css -->
    <link href="{{ asset('admins/vendor/glightbox/glightbox.min.css') }}" rel="stylesheet">

    <!-- apexcharts css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('admins/vendor/apexcharts/apexcharts.css') }}">
@endpush
@section('content')
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                                    ...
                                    <div class="glass-effect-box position-absolute bottom-0">
                                        <div class="d-flex align-items-center flex-wrap">
                                            ...
                                            <div class="flex-grow-1 ps-5">
                                                ...
                                                <h6 class="text-primary mb-0 txt-ellipsis-1 ">r72qU2892
                                                </h6>
                                            </div>
                                            <span class="badge text-bg-primary f-s-10 ms-2">• On The
                                                Way</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-6 cart-side-card mt-3 mt-sm-0">
                                ...
                                <div class="table-responsive">
                                    <table class="table cart-side-table mb-0">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <p class="mb-0 txt-ellipsis-1">Estimated Tax (12.5%) :
                                                    </p>
                                                </td>
                                ...
                                <p class="f-w-500 mb-0 txt-ellipsis-1"> Support: <a href="email.html"
            ...
            <div class="col-sm-7 col-lg-4 col-xxl-3 ">
                <ul class="notifications-list box-list mb-4 ">
                    ...
                    <li class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            <p class="mb-0 f-w-500 f-s-16 txt-ellipsis-1">Order #1022 has been canceled
                            </p>
                ...
                <div class="card offer-card-box">
                    ...
                    <div class="card-body offer-card-body overflow-hidden ">
                        ...
                        <div>
                            ...
                            <a class="f-s-12 f-w-500 text-white text-d-underline" href="#">Minimum
                                purchase
            ...
            <div class="col-md-6  col-lg-4">
                <div class="card">
                    <div class="card-body pb-0">
                        <div class="mb-2">
                            <h4 class="text-primary">98.65% <span class="f-s-14 text-dark">Total
                                    sale</span></h4>
                        </div>
...
@push('scripts:after')
    <!-- prism js-->
    <script src="{{ asset('admins/vendor/prism/prism.min.js') }}"></script>

    <!-- Glight js -->
    <script src="{{ asset('admins/vendor/glightbox/glightbox.min.js') }}"></script>
    ...
    <!-- apexcharts js-->
    <script src="{{ asset('admins/js/ecommerce_dashboard.js') }}"></script>
@endpush
