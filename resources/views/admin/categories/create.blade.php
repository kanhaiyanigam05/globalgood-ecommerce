...
@section('content')
    <div class="container-fluid">
        ...
        <x-forms.form :action="route('admin.categories.store')" method="post" enctype="multipart/form-data" varient="reactive" class="row">
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="app-form">
                            <div class="row">
                                ...
                                <div class="col-12 mb-3">
                                    <x-forms.file name="image" label="Category Image" :useMediaLibrary="true" directory="categories" :value="old('image')"
                                        :error="$errors->first('image')" />
                                </div>
                                <div class="col-12 mb-3">
                                    <x-forms.editor id="description" rows="4" name="description" label="Description"
                                        placeholder="Enter Category Description" :value="old('description')" :error="$errors->first('description')" />
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-12 mb-3">
                                    <x-forms.input name="meta_title" label="Meta Title" placeholder="Enter meta title"
                                        :value="old('meta_title')" :error="$errors->first('meta_title')" />
                                </div>
                                <div class="col-12 mb-3">
                                ...
                                <div class="col-12 mb-3">
                                    <x-forms.textarea rows="3" name="meta_description" label="Meta Description"
                                        placeholder="Enter meta description" :value="old('meta_description')" :error="$errors->first('meta_description')" />
                                </div>
                                <div class="col-12">
                                    <div class="text-end">
