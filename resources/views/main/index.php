...
<head>
    ...
    <link rel="stylesheet" href="./assets/libraries/swiper@11/css/swiper.css">
...
<body>
    <main class="max-w-site mx-auto">
            ...
            <div class="protection-section bg-green-100 rounded-md">
                <figure class="protection-section__image-wrapper">
                    <img src="https://images.pexels.com/photos/6690884/pexels-photo-6690884.jpeg"
                        alt="Community members participating in skills training workshop"
                        class="protection-section__image" draggable="false">
                </figure>
        ...
        <section class="movement-signup">
                    ...
                    <div class="movement-signup__form">
                        <div class="movement-signup__field floating-item">
                            <input
                                type="email"
                                id="newsletter-email"
                                class="movement-signup__input floating-input"
                                placeholder=" ">
            ...
            <figure class="movement-signup__visual">
                <img
                    class="movement-signup__image"
                    src="https://images.pexels.com/photos/12663094/pexels-photo-12663094.jpeg"
                    alt="Community-driven marketplace impact"
                    draggable="false">
            </figure>
        </section>
    ...
    <script src="./assets/libraries/swiper@11/js/swiper.js"></script>
    <script src="./assets/libraries/swiper@11/js/swiper-init.js"></script>
