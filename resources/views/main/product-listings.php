...
<head>
    ...
    <link rel="icon" href="./assets/images/ggc-fav.png" type="image/png">
    <link rel="stylesheet" href="./assets/css/tailwind/tw.css">
...
<body>
    <main class="max-w-site mx-auto">
                ...
                <div class="mobile-header__top">
                    ...
                    <div class="mobile-header__left">
                        ...
                        <a href="###" class="mobile-header__logo">
                            <img src="./assets/images/ggc-logo.png" alt="GGC Logo" draggable="false">
                        </a>
                    </div>
            ...
            <div class="desktop-header">
                ...
                <ul class="desktop-header__top">
                    ...
                    <li class="desktop-header__logo">
                        <a href="###" class="desktop-header__logo-link">
                            <img src="./assets/images/ggc-logo.png" alt="GGC Logo" draggable="false"
        ...
        <section class="hero-banner">
            <img class="hero-banner__image" src="https://images.pexels.com/photos/3738387/pexels-photo-3738387.jpeg"
                alt="" draggable="false">
            ...
            <div class="catalog-toolbar___main">
                        ...
                        <div class="custom-accordion-wrapper filter-group filter-group-size" data-initially-open
                            ...
                            <div class="filter-group-content accordion-body">
                                <ul class="size-filter-list inner-body">
                                    <li class="size-filter-option"><input type="checkbox" id="XS"><label for="XS"><span
                                                class="checkbox-ui"></span>XS</label></li>
                                    <li class="size-filter-option"><input type="checkbox" id="S"><label for="S"><span
                                                class="checkbox-ui"></span>S</label></li>
                                    <li class="size-filter-option"><input type="checkbox" id="M"><label for="M"><span
                                                class="checkbox-ui"></span>M</label></li>
                                    <li class="size-filter-option"><input type="checkbox" id="L"><label for="L"><span
                                                class="checkbox-ui"></span>L</label></li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="catalog-main">
                    ...
                    <div class="catalog-product-grid">
                        ...
                        <?php renderProductCard($newArrival); ?>
                        <?php endforeach; ?>
                    </div>
        ...
        <section class="impact-products">
            ...
            <div class="impact-products__grid">
                ...
                <?php include('components/product-card-2.php');
                ...
                $impactProducts = [
                    [
                        ...
                        "back"  => "https://images.pexels.com/photos/6311605/pexels-photo-6311605.jpeg",
                        "name"  => "Handwoven Ethical Summer Dress",
                        "description" => "Lightweight handwoven dress crafted by artisans using breathable, ethically sourced fabrics.",
                        "price" => "14,499",
                        "soldOut" => false,
                        "discountPercent" => 15,
                        "condition_badge" => "new"
                    ...
                    [
                        ...
                        "back"  => "https://images.pexels.com/photos/7691166/pexels-photo-7691166.jpeg",
                        "name"  => "Sustainable Tailored Trousers",
                        "description" => "Modern tailored trousers designed with sustainable materials and long-lasting construction.",
                        "price" => "21,999",
                        "soldOut" => false,
                        "discountPercent" => 20,
                    ],
                    [
                        ...
                        "back"  => "https://images.pexels.com/photos/7691106/pexels-photo-7691106.jpeg",
                        "name"  => "Community-Made Casual Jacket",
                        "description" => "Comfortable casual jacket refurbished and finished by skilled community artisans.",
                        "price" => "29,750",
                        "soldOut" => true,
                        "discountPercent" => 0,
                    ...
                    [
                        ...
                        "back"  => "https://images.pexels.com/photos/5704834/pexels-photo-5704834.jpeg",
                        "name"  => "Organic Cotton Relaxed Tee",
                        "description" => "Soft organic cotton t-shirt made without harmful chemicals for everyday wear.",
                        "price" => "7,999",
                        "soldOut" => false,
                        "discountPercent" => 10,
                        "condition_badge" => "new"
                    ...
                    [
                        ...
                        "back"  => "https://images.pexels.com/photos/6311613/pexels-photo-6311613.jpeg",
                        "name"  => "Ethical Wide-Leg Lounge Pants",
                        "description" => "Relaxed-fit lounge pants ethically produced for all-day comfort at home or outside.",
                        "price" => "18,650",
                        "soldOut" => false,
                        "discountPercent" => 5,
                        "condition_badge" => "refurbished"
                    ...
                    [
                        ...
                        "back"  => "https://images.pexels.com/photos/7691203/pexels-photo-7691203.jpeg",
                        "name"  => "Fair-Trade Sleeveless Top",
                        "description" => "Breathable sleeveless top made under fair-trade standards by ethical cooperatives.",
                        "price" => "9,899",
                        "soldOut" => false,
                        "discountPercent" => 0,
                        "condition_badge" => "donated"
                    ...
                    [
                        ...
                        "back"  => "https://images.pexels.com/photos/6311624/pexels-photo-6311624.jpeg",
                        "name"  => "Minimalist Ethical Office Shirt",
                        "description" => "Clean, minimalist office shirt responsibly made for professional everyday wear.",
                        "price" => "13,999",
                        "soldOut" => true,
                        "discountPercent" => 0,
                    ],
                ...
                foreach ($impactProducts as $impactProduct) {
                    renderProductCardAlt($impactProduct);
                }
                ?>
        ...
        <section class="action-section">
            <figure class="action-image">
                <img src="https://images.pexels.com/photos/6646864/pexels-photo-6646864.jpeg" alt="" draggable="false">
            </figure>
            ...
            <div class="action-content">
                ...
                <div class="action-buttons">
                    ...
                    <a href="###" class="btn-basic action-btn donate dark-btn"><span class="text">Donate Goods</span></a>
                    <a href="###" class="btn-basic action-btn volunteer"><span class="text">Volunteer With Us</span></a>
                </div>
            </div>
        </section>
    ...
    <script src="./assets/libraries/toolcool-range-slider@4.0.28/toolcool-range-slider.min.js"></script>
    <script src="./assets/libraries/gsap@3.12.7/gsap.min.js"></script>
