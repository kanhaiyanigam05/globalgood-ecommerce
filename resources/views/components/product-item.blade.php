...
$price = isset($item['price'])
    ...
    // Discount percentage
    $discountPercent = intval($item['discountPercent'] ?? 0);
    ...
    <div class="product-card">
        <div class="product-top-wrapper">
            ...
            <a href="###" class="product-image-wrapper{{ $isSoldOut ? ' grayscale' : '' }}">
                <img class="product-image-front" src="{{ $item['front'] }}" alt="" draggable="false" />
                <img class="product-image-back" src="{{ $item['back'] }}" alt="" draggable="false" />
            </a>

            <div class="product-badge-wrapper-right{{ (empty($item['bestseller']) ? ' mt-3' : '') . ($isSoldOut ? 'grayscale' : '') }}">
                @if (!empty($item['bestseller']))
            ...
            @if (!$isSoldOut && $discountPercent > 0)
